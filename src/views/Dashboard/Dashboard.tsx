...
import {
  ...
  change_hvac_filters,
  clean_dryer_vents,
  dishwasher_maintenance,
  electrical_system_check,
  exterior_painting,
  fire_safety_inspection,
  garbage_disposal,
  gutter_cleaning,
  lawn_garden_maintenance,
  pest_control,
  plumbing_repairs,
  pressureWash,
  roof_inspection,
    ...
    const getData = async () => {
      try {
        const response = await fetch(
          "https://homeshield-flask.onrender.com/api/list",
          {
            method: "POST",
    ...
    <>
      ...
      <div className="Welcome-container">
        ...
        <button className="PDF-Download">
          ...
          >
            <path
              d="M3 13.5L3 14.375C3 15.8248 4.17525 17 5.625 17L14.375 17C15.8247 17 17 15.8248 17 14.375L17 13.5M13.5 10L10 13.5M10 13.5L6.5 10M10 13.5L10 3.00003"
              stroke="#1F2937"
              strokeWidth="1.5"
              strokeLinecap="round"
          ...
          <div key={index} className="card">
            ...
            <div className="card-details">
              ...
              <p className="DIY-badge">
                ...
                {/* {task.Frequency === "Every 2 Weeks" && <img src={} alt={task.Frequency} />} */}
                ...
                {/* {task.Frequency === "Every Month" && <img src={} alt={task.Frequency} />} */}
              </p>
            </div>
          </div>
        ))}
